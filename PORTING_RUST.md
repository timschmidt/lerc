...
- `cargo test`: passed, 168 unit tests.
...
- Floating-point Huffman, predictor-backed modes, and encode-side Huffman still have a larger state surface and need separate cross-language fixtures before being treated as parity-complete.
